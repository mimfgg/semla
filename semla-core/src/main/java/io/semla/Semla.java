...
public class Semla implements Injector {
    ...
    public static class Configurator {
        ...
        private List<Throwables.UnaryOperator<Binder>> bindings = Lists.of(
            ...
            binder -> binder.bind(new TypeLiteral<Supplier<UUID>>() {}).to(uuidSupplier)
        );

        public Configurator withDefaultDatasource(DatasourceConfiguration defaultDatasource) {
        ...
        public class BulkDatasourceConfigurator {
            ...
            public Configurator as(DatasourceConfiguration datasourceConfiguration) {
                classes.forEach(clazz -> datasources.add(datasourceConfiguration.create(EntityModel.of(clazz))));
