...
public class ReadOneWriteAllDatasourceTest extends ReplicatedDatasourceTest<ReadOneWriteAllDatasource<Player>> {
    ...
    public static final UnaryOperator<DatasourceConfiguration> WRAPPER = defaultDatasource -> ReadOneWriteAllDatasource.configure().withDatasources(defaultDatasource, defaultDatasource);
