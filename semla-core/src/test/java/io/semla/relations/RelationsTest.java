...
import static io.semla.model.FruitManager.Sort.id;
...
public class RelationsTest {
    ...
    public void includeAParent() {
        ...
        assertThat(apple.genus).isNotNull();
        assertThat(apple.genus.name).isEqualTo("malus");
    }
    ...
    public void includeAParentAndAChild() {
        ...
        assertThat(malus.family).isNotNull();
        assertThat(malus.family.name).isEqualTo("Rosaceae");
        assertThat(malus.fruits.size()).isEqualTo(1);
        assertThat(malus.fruits.get(0).name).isEqualTo("apple");
    }
    ...
    public void includeShouldNotLoopForever() {
        ...
        assertThat(malus.fruits).isNotNull().isNotEmpty();
        assertThat(malus.fruits.get(0).genus).isNotNull();
    ...
    public void includeASecondDegreeParent() {
        ...
        assertThat(apple.genus).isNotNull()
        ;
        assertThat(apple.genus.family).isNotNull();
        assertThat(apple.genus.family.name).isEqualTo("Rosaceae");
    }
    ...
    public void includeMultipleSecondDegreeParent() {
        ...
        assertThat(apple.genus.family).isNotNull();
        assertThat(apple.genus.family.name).isEqualTo("Rosaceae");
        assertThat(apple.genus.fruits.size()).isEqualTo(1);
    }
    ...
    public void includeASecondDegreeParentAndAMatchingGrandChild() {
        ...
        assertThat(apple.genus.family).isNotNull();
        assertThat(apple.genus.family.name).isEqualTo("Rosaceae");
        assertThat(apple.genus.family.genuses.get(0).fruits.get(0).id).isEqualTo(apple.id);
        assertThat(apple.genus.family.genuses.get(1).fruits.get(0).id).isEqualTo(3);
    }
    ...
    public void embeddedObject() {
        ...
        assertThat(family.information.get("something")).isEqualTo("value");
    }
    ...
    public void cascadePersist() {
        ...
        assertThat(fruits.orderedBy(id().desc()).first().get().name).isEqualTo("plum");
        ...
        assertThat(fruits.orderedBy(id().desc()).first().get().name).isEqualTo("pear");
    }
    ...
    public void cascadeRemove() {
        ...
        assertThat(families.delete(2)).isTrue();
