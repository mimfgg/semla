...
public class SoftKeyValueDatasource<T> extends KeyValueDatasource<T> {
    ...
    public static SoftKeyValueDatasource.Configuration configure() {
        return new SoftKeyValueDatasource.Configuration();
    }

    @TypeName("soft-key-value")
    public static class Configuration extends KeyValueDatasource.Configuration<SoftKeyValueDatasource.Configuration> {
