...
public class ShardedDatasource<T> extends Datasource<T> {
    ...
    public static ShardedDatasource.Configuration configure() {
        return new ShardedDatasource.Configuration();
    }
    ...
    public static class Configuration implements Datasource.Configuration {
        ...
        @Deserialize
        public Configuration withStrategy(ShardedDatasource.ShardingStrategy strategy) {
        ...
        @Deserialize
        public Configuration withRebalancing(boolean rebalacing) {
            this.rebalacing = rebalacing;
            return this;
        }
