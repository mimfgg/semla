...
public abstract class CompositeKeyValueDatasourceTest<DatasourceType extends Datasource<Player>> extends KeyValueDatasourceTest {
    ...
    protected CompositeKeyValueDatasourceTest(UnaryOperator<Datasource.Configuration> wrapper,
